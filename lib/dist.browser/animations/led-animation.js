...
var LedAnimation = /** @class */ (function () {
     ...
     */
    LedAnimation.prototype.play = function (duration, callback, easingFunction) {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, new Promise(function (finish) {
                        ...
                        _this.timer = setInterval(function () {
                            ...
                            setTimeout(function () { return callback(_this.getStateForProgress(easingFunction(progress))); }, 0);
                            elapsed += frequency;
                        }, frequency);
                    })];
            });
